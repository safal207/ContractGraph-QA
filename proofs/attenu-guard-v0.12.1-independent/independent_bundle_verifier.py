#!/usr/bin/env python3
"""Standalone independent scorer for Attenu bundle_vectors_v1.2.
...
``bundle_vectors_v1.json`` corpus revision ``bundle_vectors_v1.2``.
...
def main() -> int:
    ...
    report = {
        "verifier": {
            ...
            "claim_boundary": "released bundle_vectors_v1.2 corpus only; not a general audit or runtime certification",
        },
        "environment": {
